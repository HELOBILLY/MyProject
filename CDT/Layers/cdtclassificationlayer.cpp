...
QgsFeatureRendererV2 *CDTClassificationLayer::DetectionRenderer()
{
    QVariantMap clsInfo = this->clsInfo();
    ...
    QgsCategorizedSymbolRendererV2* categorizedSymbolRenderer = new QgsCategorizedSymbolRendererV2("category",categoryList);
    return categorizedSymbolRenderer;
}
