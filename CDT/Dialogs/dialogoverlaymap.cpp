...
DialogOverlayMap::DialogOverlayMap(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::DialogOverlayMap)
{
    ui->setupUi(this);
...
DialogOverlayMap::~DialogOverlayMap()
{
    delete ui;
}

void DialogOverlayMap::on_radioButton_Current_clicked()
{

}
//Browse new customized map template
void DialogOverlayMap::on_pushButton_clicked()
{
...
void DialogOverlayMap::on_pushButton_OutPut_PDF_clicked()
{
...
void DialogOverlayMap::on_pushButton_OutPut_Img_clicked()
{
