...
#include "MapTools/cdtdeleteshp.h"
...
void CDTProjectWidget::onDeleteShp(bool toggle)
{
    if (toggle)
    {
        mapCanvas->unsetMapTool(mapCanvas->mapTool());
        mapCanvas->setMapTool(new qgis_devMapToolIdentifyAction(mapCanvas));
    }
}
...
QToolBar *CDTProjectWidget::initToolBar()
{
    ...
    toolButtonDeleteShp = new QToolButton(this);
    toolButtonDeleteShp->setText(tr("Identify Shp"));
    toolButtonDeleteShp->setToolTip(toolButtonDeleteShp->text());
    toolButtonDeleteShp->setIcon(QIcon(":/Icons/Identify.png"));
    toolButtonDeleteShp->setCheckable(true);
    ...
    group->addButton(toolButtonDeleteShp);
    ...
    toolBar->addWidget(toolButtonDeleteShp);
    ...
    connect(toolButtonDeleteShp,SIGNAL(toggled(bool)),this,SLOT(onDeleteShp(bool)));
...
CDTProjectLayer *CDTProjectWidget::Getproject()
{
    return project;
}
void CDTProjectWidget::untoggledToolBar()
{
    ...
    toolButtonDeleteShp->setChecked(false);
}
